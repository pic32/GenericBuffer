...
/*
	...
	Parameters: 
		...
		will be inititalized.  If NULL is passed in then this method will 
...
*/
	...
	*/
	...
	UINT32 *SequenceStartingIndex - This is optional.  If valid it will put the index of the beginning of the sequence found.
	...
	* @param SequenceStartingIndex - Optional, if the sequence is found its starting index will be put in here.
	...
	*/
	...
	BOOL GenericBufferContainsSequence(GENERIC_BUFFER *GenericBuffer, BYTE *Sequence, UINT32 SequenceSize, UINT32 *SequenceStartingIndex);
